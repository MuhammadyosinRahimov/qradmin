          ...
          {editingRestaurant && (
            <>
              ...
              {editingRestaurant.onlinePaymentAvailable && (
                <div className="flex items-center gap-2 p-3 bg-[var(--status-success-bg)] rounded-lg mt-4">
                  <svg className="w-5 h-5 text-[var(--status-success)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-[var(--status-success)]">Онлайн-оплата активна</span>
                </div>
              )}
            </>
          )}
